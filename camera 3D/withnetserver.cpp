...
//	shape_predictor sp;
//	std::string shape_model = "D:/shape_predictor_68_face_landmarks.dat";
...
//			recv(sockServer, (char*)&centroid_arr, sizeof(centroid_arr), 0);
//			recv(sockServer, (char*)&eyedis, sizeof(eyedis), 0);
//			xx = centroid_arr.x;
//			yy = centroid_arr.y;
//
//		}
...
//
//			rowang = abs(atan(((320 - xx - 700) * 1 / 100 + screenwidth / 2) / screendepth) + atan((screenwidth / 2 - (320 - xx - 700) * 1 / 100) / screendepth));
//			//cout << glm::degrees(rowang) << endl;
//			colang = abs(atan(((240 - yy + 120) * 1 / 100 + screenheight / 2) / screendepth) + atan((screenheight / 2 - (240 - yy + 120) * 1 / 100) / screendepth));
...
//
//
//			front.x = -sin(atan(((320 - xx - 700) * 1 / 100 + screenwidth / 2) / screendepth) - 0.5*rowang);
//			front.y = sin(0.5*colang - atan(((240 - yy + 120) * 1 / 100 + screenheight / 2) / screendepth));
//			front.z = -cos(0.5*colang - atan(((240 - yy + 120) * 1 / 100 + screenheight / 2) / screendepth)) * cos(atan(((320 - xx - 700) * 1 / 100 + screenwidth / 2) / screendepth) - 0.5*rowang);
